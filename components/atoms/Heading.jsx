...
const Heading = ({ type, text, href }) => {
  ...
  switch (type) {
    ...
    case '2':
      ...
      break;
    case '3':
      heading = <h2 className="text-[14px] font-[500] text-[#173e4e]"> {text}</h2>

      break;
    case '4':
      heading = <h2 className="text-[16px] text-[white]">{text}</h2>
    ...
    case '7':
      ...
      break;
    case '8':
      heading = <h2 className="text-[29px] font-[400] text-[#00918E]">{text}</h2>
    ...
    case '9':
      ...
      break;
    case '10':
      heading = <h2 className="text-[34px] text-[#00918E] font-[500] ">{text}</h2>

      break;
    case '11':
      heading = <h2 className="text-[36px] text-[white] font-[600]">{text}</h2>

      break;
    case '12':
      heading = <h2 className="text-[39px] font-[600] text-[#00918E] "> {text}</h2>
    ...
    case '13':
      ...
      break;
    case '14':
      heading = <h2 className="text-[16px] font-medium text-[#14212d] border-b-1 border-black border-10%">{text}</h2>

      break;
    case '15':
      heading = <h2 className="text-[16px] text-[#0d141db3] ">{text}</h2>
    ...
    case '19':
      ...
      break;
    case '20':
      heading = <h2 className="text-[16px] text-[#fff]">{text}</h2>
    ...
    case '22':
      ...
      break;
    case '23':
      heading = <h2 className="text-[36px] text-[#00918E] font-[600]">{text}</h2>
