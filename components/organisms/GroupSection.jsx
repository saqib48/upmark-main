  ...
  return (
    <Container>
      <div className=' pb-[50px] overflow-hidden'>
        ...
        <div c1assName="h-[400px] overflow-hidden rounded-[20px] flex items-center justify-center 2xl:w-[100%]  xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] w-[100%] 2xl:my-[20px] xl:my-[20px] lg:my-[20px] md:my-[20px] sm:my-[20px] my-[20px]" data-aos="zoom-out-down" >
          <Image width={500} height={400} className=' 2xl:w-[100%]  xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] w-[100%]  rounded-[20px] ' src="/assits/images/groupbanner.png" alt="image" />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl-grid-cols-3 gap-4 my-[30px]">
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/it.svg' alt='icon' text1='IT Infrastructure Management ' text2='Keep your IT infrastructure reliable, secure, and scalable with our comprehensive management services.   .....         .           .       .                .             .' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/2.svg' alt='icon' text1='Business Process Automation ' text2='Elevate efficiency, reduce costs, and enhance customer service with automated business processes.       .......             .               .          .            .             . .' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/3.svg' alt='icon' text1='Data Analytics and Business Intelligence ' text2='Unleash the power of data to gain valuable insights, make informed decisions, and drive business growth.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/4.svg' alt='icon' text1='Systems Integration ' text2='Manage and control changes to your IT systems and infrastructure to minimize disruptions and ensure smooth implementation.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/5.svg' alt='icon' text1='Compliance and Regulatory Consulting ' text2='Navigate complex IT regulations and maintain compliance with our comprehensive consulting services.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/6.svg' alt='icon' text1='Application Development and Maintenance ' text2='Develop, modernize, and maintain software applications tailored to your specific business needs.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/7.svg' alt='icon' text1='Vendor Management ' text2='Optimize your IT vendor relationships to ensure high-quality services, competitive pricing, and seamless collaborations.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/8.svg' alt='icon' text1='Help Desk and Support ' text2='Empower your team with prompt and reliable IT support to keep them productive and minimize downtime.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/9.svg' alt='icon' text1='Cybersecurity ' text2='Safeguard your valuable data and systems from cyber threats with our robust cybersecurity solutions.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/10.svg' alt='icon' text1='Cloud Computing ' text2='Embrace the flexibility and cost-effectiveness of cloud computing to power your business operations.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/11.svg' alt='icon' text1='Training and Education ' text2='Invest in your employees IT skills and knowledge with customized training programs.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/12.svg' alt='icon' text1='Asset Management ' text2='Track, manage, and optimize the utilization of your IT assets to maximize their value and ensure compliance.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/13.svg' alt='icon' text1='Network Consulting and Engineering ' text2='Optimize your network performance, reliability, and security with our expert network consulting services.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/14.svg' alt='icon' text1='Governance and Risk Management ' text2='Align IT with business objectives and manage risks with our strategic governance and management solutions.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/16.svg' alt='icon' text1='Project Management ' text2='Ensure your IT projects are delivered on time, within budget, and to the highest quality standards with our expert project management services.' /></div>
          <div className='w-[100%]' data-aos="fade-up"><Product src='/assits/images/17.svg' alt='icon' text1='Contingency Planning ' text2='Be prepared for unexpected events with our disaster recovery planning, testing, and implementation services.' /></div>
        </div>
        <div className="text-center 2xl:py-[100px] xl:py-[100px] lg:py-[100px] md:py-[50px] sm:py-[20px] py-[10px] " data-aos="fade-right"  >
        ...
        <div id='' className="2xl:flex 2xl:flex-nowrap 2xl:justify-between xl:flex xl:flex-nowrap xl:justify-between lg:flex lg:flex-nowrap lg:justify-between md:flex md:flex-nowrap md:justify-between sm:flex sm:flex-wrap sm:justify-between flex flex-wrap justify-between gap-[50px] relative">
          ...
          <div className="flex flex-col gap-[10px] 2xl:w-[43%] xl:w-[43%] lg:w-[43%] md:w-[60%] sm:w-[100%] w-[100%]" >
            <div className=" tracking-[6px] border-b-4 border-[#999] 2xl:w-[30%] xl:w-[30%] lg:w-[30%] md:w-[30%] sm:w-[35%] w-[25%]" data-aos="fade-right" ><Heading type='16' text='Upmark' />
            </div>
          ...
          <span class=" absolute 2xl:left-[50%] 2xl:top-[90%] xl:left-[50%] xl:top-[90%] lg:left-[50%] lg:top-[90%] mg:left-[50%] mg:top-[90%] sm:left-[50%] sm:top-[50%] left-[50%] top-[50%]" data-aos="zoom-out-left">
