  ...
  return (
    <div className='w-[100%] relative 2xl:flex 2xl:flex-nowrap 2xl:items-center 2xl:justify-between 2xl:px-[70px] 2xl:my-[100px] xl:flex xl:flex-nowrap xl:items-center xl:justify-between xl:px-[70px] xl:my-[100px] lg:flex lg:flex-nowrap lg:items-center lg:justify-between lg:px-[70px] lg:my-[100px] md:flex md:flex-wrap-reverse md:items-center md:justify-between md:px-[50px] md:my-[100px] sm:flex sm:flex-wrap-reverse sm:items-center sm:px-[0px] sm:my-[30px] flex flex-wrap-reverse items-center px-[10px] my-[30px]'>
      <div className="flex flex-col gap-[10px] 2xl:w-[40%] xl:w-[40%] lg:w-[40%] md:w-[50%] sm:ml-[20px] sm:w-[100%] ml-[20px] w-[100%]">
        <div className=" tracking-[4px] border-b-4 border-[#999] w-[18%]" data-aos="zoom-in" data-aos-delay="900"><Heading type='16' text='Plastichero' />
        </div>
        <div className="py-[10px]" data-aos="fade-up" data-aos-delay="900">  <Heading type='10' text='Walking Towards Sustainability' />
        </div>
        <div className="py-[10px]" data-aos="fade-up" data-aos-delay="950" ><Heading type='5' text='To make the world a greener place for future generations, we’ve lent our support to Plastichero in building their platform and streamlining their services. ' />
        </div>
        <div className='flex items-center ' data-aos="fade-up" data-aos-delay="1000"><span className='h-[8px] w-[7px] bg-[#00918E] mr-[5px] rounded-[100%]'></span><Heading type='2' text='Developing an eco-friendly platform integrating AI and analytics' /></div>
        <div className='flex items-center ' data-aos="fade-up" data-aos-delay="1000"> <span className='h-[8px] w-[7px] bg-[#00918E] mr-[5px] rounded-[100%]'></span><Heading type='2' text='Optimized resource management and enhanced sustainability efforts' /></div>
        <div className='flex items-center ' data-aos="fade-up" data-aos-delay="1000"><span className='h-[8px] w-[7px] bg-[#00918E] mr-[5px] rounded-[100%]'></span><Heading type='2' text='Enhanced supply chain efficiency through digital transformation' /></div>
        <div className='flex items-center ' data-aos="fade-up" data-aos-delay="1000"><span className='h-[8px] w-[7px] bg-[#00918E] mr-[5px] rounded-[100%]'></span><Heading type='2' text='Provided consumers with tools for informed, sustainable choices' /></div>
      ...
      <div className="w-[100%] sm:ml-[30px] ml-[30px]" data-aos="fade-left" data-aos-duration="1000" >
      ...
      <div class="mt-[-20%] md:mt-0 shadow text-here flex gap-[10px] bg-white absolute rounded-[20px] px-[10px] pb-[5px] 2xl:top-[10%] 2xl:left-[50%] xl:top-[10%] xl:left-[50%] lg:top-[10%] lg:left-[50%] md:top-[10%] md:left-[10%] sm:top-[5%] sm:left-[10%] top-[5%] left-[10%]" data-aos="fade-down" data-aos-duration="100">
      ...
      <div className="shadow absolute p-[20px] rounded-[20px]  bg-[#ffffff]  2xl:bottom-[10%] 2xl:right-[10%] 2xl:w-[20%]  xl:bottom-[10%] xl:right-[10%] xl:w-[20%] lg:bottom-[10%] lg:right-[10%] lg:w-[20%] md:bottom-[55%] md:right-[20%] md:w-[30%] sm:bottom-[45%] sm:right-[10%] sm:w-[37%]  bottom-[65%] right-[10%] w-[77%]" data-aos="fade-left" data-aos-duration="1000">
